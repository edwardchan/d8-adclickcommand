...
/**
 * Save and Update Configuration form class.
 */
class SaveUpdateConfigForm extends ConfigFormBase implements ContainerInjectionInterface {
  ...
  /**
   * SaveUpdateConfigForm constructor.
   *
  ...
  public function getFormId() {
    return 'save_update_config_form';
  }
  ...
  public function buildForm(array $form, FormStateInterface $form_state) {
    ...
    $config = $this->config('g9.save_update.settings');
    ...
    foreach ($content_types as $type) {
      ...
      // Only show the content types that have a 'field_edit_revised'.
      if (isset($field_definitions['field_edit_revised'])) {
