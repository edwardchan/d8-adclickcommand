...
/**
 * Highlight Configuration form class.
 */
class HighlightConfigForm extends ConfigFormBase implements ContainerInjectionInterface {
  ...
  /**
   * HighlightConfigForm constructor.
   *
  ...
  public function buildForm(array $form, FormStateInterface $form_state) {
    ...
    $config = $this->config('g9.highlight.settings');
    ...
    foreach ($content_types as $type) {
      ...
      // Only show the content types that have a 'field_highlight'.
      if (isset($field_definitions['field_highlight'])) {
