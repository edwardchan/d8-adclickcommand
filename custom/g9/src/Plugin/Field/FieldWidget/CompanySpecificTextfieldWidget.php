...
/**
 * Plugin implementation of the 'Company Specific Textfield' widget.
 *
 * @FieldWidget(
 *   id = "company_specific_textfield",
 *   label = @Translation("Company Specific Textfield"),
 *   field_types = {
 *     "string",
 *     "string_long"
 *   }
 * )
 */
class CompanySpecificTextfieldWidget extends StringTextfieldWidget {
  ...
  public function settingsForm(array $form, FormStateInterface $form_state) {
    $terms = \Drupal::service('entity_type.manager')->getStorage('taxonomy_term')->loadTree('company');
    $companies = [];
